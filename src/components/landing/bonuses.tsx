  ...
  return (
    <section className="bg-plum px-5 py-16 sm:py-24">
      <div className="mx-auto max-w-5xl">
        ...
        <figure className="mx-auto mt-10 mb-4 w-full max-w-3xl">
          <img
            src={premiumMateriais.url}
            alt="Prévia dos materiais extras da versão Premium: planner de 21 dias, cardápio, receitas e controle de hidratação"
            loading="lazy"
