            ...
            return (
              <div key={faq.question}>
                <button
                  ...
                  className="flex w-full items-center justify-between gap-4 px-6 py-5 text-left transition-colors hover:bg-muted/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-action"
                >
                  ...
                  <span
                    aria-hidden="true"
                    className={cn(
                      "flex size-8 shrink-0 items-center justify-center rounded-full bg-action/15 text-xl font-bold leading-none text-action transition-transform duration-300",
                      isOpen && "rotate-45",
                    )}
                  >
                    +
